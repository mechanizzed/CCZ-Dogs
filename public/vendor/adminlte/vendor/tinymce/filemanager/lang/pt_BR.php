...
return array(
	...
	'Upload_base_help' => "Arraste e solte os arquivos dentro área acima ou clique nele (para navegadores modernos), caso contrário, selecione o arquivo e clique no botão. Quando terminar o upload, clique no botão de retorno superior.",
	'Type_dir' => 'dir',
	'Type' => 'Tipo',
	'Dimension' => 'Dimensão',
	'Size' => 'Tamanho',
	...
	'Paste' => 'Paste',
	'CB' => 'CB', // clipboard
	'Paste_Here' => 'Colar neste diretório',
	'Paste_Confirm' => 'Você tem certeza que deseja colar neste diretório? Isto irá sobreescrever os arquivos e pastas já existentes.',
	'Paste_Failed' => 'Erro ao copiar o(s) arquivo(s)',
	'Clear_Clipboard' => 'Clipboard limpo',
	'Clear_Clipboard_Confirm' => 'Você tem certeza que deseja limpar seu clipboard?',
	...
	'Valid_Extensions' => 'Extenções válidas: %s', // %s = txt,log etc.
	'Upload_message' => "Arraste os arquivos aqui para fazer upload",
);
